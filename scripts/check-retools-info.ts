...
//    [2026-09-06 지시 039] 환불정책 링크는 아예 없어야 한다. 이 앱은 무료이고 결제가
//    없어 환불할 것이 없다. 약관에 환불 조항을 넣지 않기로 한 판단과 짝이다.
//    링크만 남으면 두 문서가 다른 말을 한다.
if (푸터.includes("refund-policy")) {
  문제.push(
    "components/Footer.tsx 에 환불정책 링크가 있습니다. 이 앱은 무료이고 결제가 없어 환불할 것이 없습니다"
  );
}
