...
- 값의 정본은 `retools-labs/hq` 저장소의 `정본.md` 다. 제품명(2절) · 무료 체험 1개월·카드 없이(5절) · 주소 `retools.kr/book/realty`(3절).
- 글꼴 Pretendard woff2 는 저장소에 없다. 작업 루트의 `retools-print\_원고\fonts\` 의 Medium·SemiBold·Bold·ExtraBold 넷을
