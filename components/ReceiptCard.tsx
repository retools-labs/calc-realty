...
const ReceiptCard = forwardRef<HTMLDivElement, Props>(function ReceiptCard(
  ...
  return (
    <div ref={ref} className="rounded-xl border border-dashed border-[#C7D2DB] bg-white">
      ...
      {/* [X-41 2026-09-07] 3판. 2판은 옛 제품명과 폐기된 값(2인 평생 무료)이 그림 안에 박혀 있어
          코드로 못 바꿨다. 3판은 값을 정본.md 에서 옮겨 그렸고 생성 소스는
          scripts/receipt-cta/ 에 있다. alt 는 이미지에 실제로 적힌 글 그대로다. 그림을 다시
          그리면 alt 도 함께 고친다. */}
