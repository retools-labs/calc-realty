...
const ReceiptCard = forwardRef<HTMLDivElement, Props>(function ReceiptCard(
  ...
  return (
    <div ref={ref} className="overflow-hidden rounded-xl border border-dashed border-[#C7D2DB] bg-white">
      ...
      <div className="flex items-center justify-between gap-3 bg-[#0A2540] px-4 py-3 leading-relaxed">
        <span className="flex min-w-0 items-center gap-1.5">
          ...
          <span className="truncate text-[10.5px] text-[#a9c2d6]">공인중개사 스마트 정산장부</span>
        </span>
