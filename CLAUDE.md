...
무인 자동화 SNS 봇). **계산기 5개(3.1~3.5) 전부 구현·배포 완료(2026-08-17), 4장 디자인
리스타일 + 명칭 변경(1차)도 완료(2026-08-18 — README "11." 참고).** 남은 건 탭 라벨 세부
변경(README "6." 참고, 우선순위 낮음), 앱인토스 SDK 연동, SNS 자동화 봇.
...
"11. 2026-08-18 작업 내역(부산)" 섹션 참고. 요약:
